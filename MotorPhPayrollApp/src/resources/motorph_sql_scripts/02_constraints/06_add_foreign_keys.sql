...
-- UserAccess → AccessCategory, ResourceID, ActionID 		
-- Foreign key constraints with controlled deletion behavior
ALTER TABLE user_access
  ADD CONSTRAINT fk_access_category
    FOREIGN KEY (access_category_id)
    REFERENCES access_category(access_category_id)
    ON DELETE RESTRICT;
...
ALTER TABLE user_access
  ADD CONSTRAINT fk_resource
    ...
    REFERENCES user_resource(resource_id)
    ON DELETE RESTRICT;
    
ALTER TABLE user_access
  ADD CONSTRAINT fk_action
    FOREIGN KEY (action_id)
    REFERENCES user_action(action_id)
    ON DELETE RESTRICT;

-- RoleAccess → UserRole, Access
...
ALTER TABLE role_access
  ADD CONSTRAINT fk_role_access_user_access
    FOREIGN KEY (access_id)
    REFERENCES user_access(access_id);
