...
ALTER TABLE user_action
  ADD CONSTRAINT uq_action_name
    UNIQUE (action_name);
    
-- 12. UserResource: 
ALTER TABLE user_resource
  ADD CONSTRAINT uq_resource_name
    UNIQUE (resource_name);
    
-- 13. UserAccess: 
ALTER TABLE user_access
  ADD CONSTRAINT uq_access_name			-- Prevent duplicate access labels
    UNIQUE (access_name),
ADD CONSTRAINT uq_resource_action		-- Prevent duplicate resource-action pairs
