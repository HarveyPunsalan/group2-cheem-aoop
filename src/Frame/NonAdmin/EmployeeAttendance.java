...
public class EmployeeAttendance extends javax.swing.JFrame {
    ...
    private void jComboBoxAttendancePeriodActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBoxAttendancePeriodActionPerformed
        ...
        Connection conn = DBConnection.getConnection();  // Make sure to import DBConnection & Connection
        AttendanceService dtrManager = new AttendanceService(conn);
        EmployeeService employeeService = new EmployeeService(); // assuming EmployeeService has no-arg constructor
